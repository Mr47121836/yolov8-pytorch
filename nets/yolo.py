...
from nets.simam import SimAM  # 导入 SimAM
from nets.yolo_training import weights_init
from utils.utils_bbox import make_anchors

def fuse_conv_and_bn(conv, bn):
    # 混合 Conv2d + BatchNorm2d 减少计算量
...
class YoloBody(nn.Module):
    def __init__(self, input_shape, num_classes, phi, pretrained=False):
        ...
        self.simam_downsample1 = SimAM()  # 添加 SimAM
        # 512, 40, 40 => 512, 20, 20
        ...
        self.simam_downsample2 = SimAM()  # 添加 SimAM
    ...
    def forward(self, x):
        ...
        P4 = self.simam_upsample1(P4)  # 应用 SimAM

        P4_upsample = self.upsample(P4)
        P3 = torch.cat([P4_upsample, feat1], 1)
        P3 = self.conv3_for_upsample2(P3)
        P3 = self.simam_upsample2(P3)  # 应用 SimAM

        P3_downsample = self.down_sample1(P3)
        P4 = torch.cat([P3_downsample, P4], 1)
        P4 = self.conv3_for_downsample1(P4)
        P4 = self.simam_downsample1(P4)  # 应用 SimAM

        P4_downsample = self.down_sample2(P4)
        P5 = torch.cat([P4_downsample, feat3], 1)
        P5 = self.conv3_for_downsample2(P5)
        P5 = self.simam_downsample2(P5)  # 应用 SimAM
